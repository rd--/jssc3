...
import { randomFloat, randomInteger } from './sc3-number.js'
...
export function timesRepeat(count: number, proc: (aValue: void) => void): void { for(var i = 0; i < count; i++) { proc(); } }
...
export function value(proc: (p1?: any, p2?: any) => any, maybeArg1?: any, maybeArg2?: any): any { return maybeArg2 ? proc(maybeArg1, maybeArg2) : (maybeArg1 ? proc(maybeArg1) : proc()); }
