...
function ui_pte_ace_init(parentElement) {
    ...
    consoleDebug('ui_pte_ace_init: finished');
}
...
function ui_pte_textarea_init(parentElement) {
    ...
    consoleDebug('ui_pte_textarea_init: finished');
}
...
function ui_pte_get_text() {
    ...
    consoleDebug('ui_pte_get_text', editorText);
    return editorText;
}
...
function ui_pte_get_selected_text() {
    ...
    consoleDebug('ui_pte_get_selected_text', currentText);
