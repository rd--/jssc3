import { Queue, queueAsArray, queueNew, queuePush } from './queue.ts';
...
export function uint8ArrayIntoQueue(
	u8Array: Uint8Array,
...
export function flattenByteEncodingIntoQueue(
	aTree: Tree<Uint8Array>,
	numberQueue: Queue<number>,
): void {
